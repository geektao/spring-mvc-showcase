...
public class ResponseController {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/entity/status")
	public @ResponseBody ResponseEntity<String> responseEntityStatusCode() {
		return new ResponseEntity<String>("The String ResponseBody with custom status code (403 Forbidden)",
				HttpStatus.FORBIDDEN);
	}

	@RequestMapping(method = RequestMethod.GET, value = "/entity/headers")
	public @ResponseBody ResponseEntity<String> responseEntityCustomHeaders() {
